...
10. 你需要分号结尾吗?
    ...
    ```bash
    ? Do you require semicolons? (Y/n) // 你需要分号结尾吗?
    ```

11. 您希望配置文件的格式是什么?

    ```bash
    ? What format do you want your config file to be in? (Use arrow keys) // 您希望配置文件的格式是什么?
    > JavaScript
      YAML
      JSON
    ```

12. 初始化之后, 在你的项目根目录下面会有一个 .eslintrc.js 文件
